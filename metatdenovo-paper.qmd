...
```{r read-eukulele-gtdb}
#| label: read-eukulele-gtdb

# TODO: Update the glob when rerun with a more recent version of the pipeline
eukulele <- Sys.glob('nextflow/*/*/summary_tables/*.taxonomy_classification.tsv.gz') %>%
  read_tsv(id = 'fname', show_col_types = FALSE) %>%
...
#| fig.height: 3
#| fig-cap: '**GTDB taxonomic annotation success.** Unweighted, weighted by count and tpm respectively.'
