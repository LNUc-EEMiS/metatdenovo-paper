...
```{r read-bunse2017-taxonomy}
#| label: read-bunse2017-taxonomy
#| cache-lazy: false

bunse2017_taxonomy <- read_tsv('data/bunse2017_taxonomy.tsv', col_types = 'cci')
```

```{r read-bunse2017-function}
#| label: read-bunse2017-function
#| cache-lazy: false

bunse2017_function <- read_tsv('data/bunse2017_function.tsv', col_types = 'cci')
```
...
eukulele %>%
  ...
  union(
    bunse2017_taxonomy %>% transmute(sample_group, family, value = cpm, method = 'Bunse et al. 2017')
  ) %>%
