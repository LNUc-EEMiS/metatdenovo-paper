...
knitr::opts_chunk$set(echo = TRUE, fig.path='figures/', cache = FALSE, fig.width = 10)
...
```{r create table for tax-annots from original paper }
#| label: tax-annots-og
...
```{r create table for func-annots from original paper }
...
#| label: fig-mst-1-annot-comparison
#| fig.height: 6
...
```{r fig-mst-1-tax-annot-comparison , echo = FALSE, warning = FALSE}
...
```{r fig-edgeR-analysis , echo = FALSE, warning = FALSE}
